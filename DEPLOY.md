...
3. **Cấu hình Project:**
   - **Project Name**: Đặt tên là `hoabanglang`
...
4. **Deploy:**
   - Click "Deploy"
   - Vercel sẽ tự động deploy và tạo URL: `https://hoabanglang.vercel.app`
...
3. **Deploy:**
   ...
   vercel
   ```
   - Khi được hỏi project name, nhập: `hoabanglang`
...
- Tên miền sẽ là: `https://hoabanglang.vercel.app`
