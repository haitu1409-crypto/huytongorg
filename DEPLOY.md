...
3. **Cấu hình Project:**
   - **Project Name**: Đặt tên là `kenkenken9999`
...
4. **Deploy:**
   - Click "Deploy"
   - Vercel sẽ tự động deploy và tạo URL: `https://kenkenken9999.vercel.app`
...
3. **Deploy:**
   ...
   vercel
   ```
   - Khi được hỏi project name, nhập: `kenkenken9999`
...
- Tên miền sẽ là: `https://kenkenken9999.vercel.app`
