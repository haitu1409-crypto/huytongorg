...
3. **Cấu hình Project:**
   - **Project Name**: Đặt tên là `daily188lux50`
...
4. **Deploy:**
   - Click "Deploy"
   - Vercel sẽ tự động deploy và tạo URL: `https://daily188lux50.vercel.app`
...
3. **Deploy:**
   ...
   vercel
   ```
   - Khi được hỏi project name, nhập: `daily188lux50`
...
- Tên miền sẽ là: `https://daily188lux50.vercel.app`
