...
2. Import project từ GitHub: `haitu1409-crypto/daily188lux50`
3. Đặt Project Name: `daily188lux50`
4. Deploy và đợi URL: `https://daily188lux50.vercel.app`

### Bước 2: Test Preview Trên Telegram

**Cách 1: Test Trực Tiếp**
1. Mở Telegram (app hoặc web)
2. Gửi link `https://daily188lux50.vercel.app` vào một chat
...
3. Nhập URL: `https://daily188lux50.vercel.app`
4. Xem preview
...
- ✅ Tồn tại và có thể truy cập: `https://daily188lux50.vercel.app/imgs/preview.jpg`
...
1. **Kiểm tra URL có truy cập được không:**
   ```bash
   curl -I https://daily188lux50.vercel.app
   ```

2. **Kiểm tra ảnh preview có truy cập được không:**
   ```bash
   curl -I https://daily188lux50.vercel.app/imgs/preview.jpg
   ```
...
- [ ] URL truy cập được: `https://daily188lux50.vercel.app`
- [ ] Ảnh preview truy cập được: `https://daily188lux50.vercel.app/imgs/preview.jpg`
