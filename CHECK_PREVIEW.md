...
### ❌ Dự án `dailykhanhnam` - Preview KHÔNG HOẠT ĐỘNG
- URL: `https://khanhnam.vercel.app`
- Đã thêm `"name": "khanhnam"` vào `vercel.json` ✅
...
### 1. ✅ Đã Cập Nhật
- [x] Thêm `"name": "khanhnam"` vào `vercel.json`
...
https://khanhnam.vercel.app
```

**Kiểm tra ảnh preview có truy cập được không:**
```bash
# Mở trình duyệt và truy cập:
https://khanhnam.vercel.app/imgs/preview.jpg
```
...
1. **Facebook Sharing Debugger:**
   ...
   - Nhập URL: `https://khanhnam.vercel.app`
...
1. Đảm bảo URL đã deploy và hoạt động: `https://khanhnam.vercel.app`
2. Mở Telegram (app hoặc web)
3. Gửi link `https://khanhnam.vercel.app` vào một chat
...
- Thử lại với URL có query string: `https://khanhnam.vercel.app?v=1`
...
- [ ] File có thể truy cập qua HTTPS: `https://khanhnam.vercel.app/imgs/preview.jpg`
...
**Nếu dự án `linkquangcaochithien` hoạt động nhưng `dailykhanhnam` không:**
- Kiểm tra xem URL `khanhnam.vercel.app` đã được deploy chưa
...
- Đảm bảo Project Name là `khanhnam`
- Kiểm tra URL hoạt động: `https://khanhnam.vercel.app`
...
- [ ] URL `https://khanhnam.vercel.app` đã được deploy và hoạt động
- [ ] File `https://khanhnam.vercel.app/imgs/preview.jpg` có thể truy cập được
