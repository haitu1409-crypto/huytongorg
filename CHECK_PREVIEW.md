...
### ❌ Dự án `kenkenken9999` - Preview KHÔNG HOẠT ĐỘNG
- URL: `https://kenkenken9999.vercel.app`
- Đã thêm `"name": "kenkenken9999"` vào `vercel.json` ✅
...
### 1. ✅ Đã Cập Nhật
- [x] Thêm `"name": "kenkenken9999"` vào `vercel.json`
...
https://kenkenken9999.vercel.app
```

**Kiểm tra ảnh preview có truy cập được không:**
```bash
# Mở trình duyệt và truy cập:
https://kenkenken9999.vercel.app/imgs/preview.jpg
```
...
1. **Facebook Sharing Debugger:**
   ...
   - Nhập URL: `https://kenkenken9999.vercel.app`
...
1. Đảm bảo URL đã deploy và hoạt động: `https://kenkenken9999.vercel.app`
2. Mở Telegram (app hoặc web)
3. Gửi link `https://kenkenken9999.vercel.app` vào một chat
...
- Thử lại với URL có query string: `https://kenkenken9999.vercel.app?v=1`
...
- [ ] File có thể truy cập qua HTTPS: `https://kenkenken9999.vercel.app/imgs/preview.jpg`
...
**Nếu dự án `linkquangcaochithien` hoạt động nhưng `kenkenken9999` không:**
- Kiểm tra xem URL `kenkenken9999.vercel.app` đã được deploy chưa
...
- Đảm bảo Project Name là `kenkenken9999`
- Kiểm tra URL hoạt động: `https://kenkenken9999.vercel.app`
...
- [ ] URL `https://kenkenken9999.vercel.app` đã được deploy và hoạt động
- [ ] File `https://kenkenken9999.vercel.app/imgs/preview.jpg` có thể truy cập được
