...
### ❌ Dự án `huytongorg` - Preview KHÔNG HOẠT ĐỘNG
- URL: `https://huytongorg.vercel.app`
- Đã thêm `"name": "huytongorg"` vào `vercel.json` ✅
...
### 1. ✅ Đã Cập Nhật
- [x] Thêm `"name": "huytongorg"` vào `vercel.json`
...
https://huytongorg.vercel.app
```

**Kiểm tra ảnh preview có truy cập được không:**
```bash
# Mở trình duyệt và truy cập:
https://huytongorg.vercel.app/imgs/preview.jpg
```
...
1. **Facebook Sharing Debugger:**
   ...
   - Nhập URL: `https://huytongorg.vercel.app`
...
1. Đảm bảo URL đã deploy và hoạt động: `https://huytongorg.vercel.app`
2. Mở Telegram (app hoặc web)
3. Gửi link `https://huytongorg.vercel.app` vào một chat
...
- Thử lại với URL có query string: `https://huytongorg.vercel.app?v=1`
...
- [ ] File có thể truy cập qua HTTPS: `https://huytongorg.vercel.app/imgs/preview.jpg`
...
**Nếu dự án `linkquangcaochithien` hoạt động nhưng `huytongorg` không:**
- Kiểm tra xem URL `huytongorg.vercel.app` đã được deploy chưa
...
- Đảm bảo Project Name là `huytongorg`
- Kiểm tra URL hoạt động: `https://huytongorg.vercel.app`
...
- [ ] URL `https://huytongorg.vercel.app` đã được deploy và hoạt động
- [ ] File `https://huytongorg.vercel.app/imgs/preview.jpg` có thể truy cập được
